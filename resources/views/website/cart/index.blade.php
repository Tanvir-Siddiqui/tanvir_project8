                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <table class="table shopping-summery text-center clean">
                                ...
                                <tr>
                                    <td class="image product-thumbnail"><img src="{{asset($cart_product->attributes->image)}}" alt="#"></td>
                                    ...
                                    <td class="price" data-title="Price"><span>{{$cart_product->price}}</span></td>
                                    <td class="text-center" data-title="Stock">
                                        <form action="{{route('cart.update', ['id' => $cart_product->id])}}" method="post">
                                            @csrf
                                            <div class="col-lg-4 col-md-3 mx-auto">
                                                <div class="input-group">
                                                    <input type="number" value="{{$cart_product->quantity}}" name="quantity" class="text-center form-control" min="1"/>
                                    ...
                                    <td class="text-right" data-title="Cart">
                                        <span>{{$cart_product->price * $cart_product->quantity}}</span>
                                    </td>
                                    <td class="action" data-title="Remove"><a href="{{route('cart.remove', ['id' => $cart_product->id])}}" class="btn-sm btn-group-sm btn-outline-danger"><i class="fi-rs-trash"></i></a></td>
                                </tr>
...
{{--                                    </td>--// upore delete btn e text-muted use kora hysilo}}
{{--                                </tr>--}}
                                </tbody>
                            </table>
                        </div>
...
{{--                            <button class="btn  mr-10 mb-sm-15" name="quantity" type="submit"><i class="fi-rs-shuffle mr-10"></i>Update Cart</button>--}}
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td class="cart_total_amount"> <i class="ti-gift mr-5"></i>{{$tax = $sum * 0.15}}</td>
                                            </tr>
                                            <tr>
                                                <td class="cart_total_label">Shipping</td>
                                                <td class="cart_total_amount"> <i class="ti-gift mr-5"></i>{{$shipping = 500}}</td>
                                            </tr>
                                            <tr>
                                                <td class="cart_total_label">Total Payable</td>
                                                <td class="cart_total_amount"><strong><span class="font-xl fw-900 text-brand">{{$totalPayable = $sum + $tax + $shipping}}</span></strong></td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
