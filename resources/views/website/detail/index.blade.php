                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-info">
                                        ...
                                        <div class="product-detail-rating">
                                            ...
                                            <div class="pro-details-brand">
                                                <span> Unit: <a href="">{{$product->unit->name}}</a></span>
                                            </div>
                                        ...
                                        <div class="clearfix product-price-cover">
                                            <div class="product-price primary-color float-left">
                                                <ins><span class="text-brand">BDT.{{$product->selling_price}}</span></ins>
                                                <ins><span class="old-price font-md ml-15">BDT.{{$product->regular_price}}</span></ins>
                                            </div>
                                        </div>
                                        ...
                                        <div class="detail-extralink">
                                            <div class="product-extra-link2">
                                                <div class="form-group qty">
                                                    <label for="color"><h5 style="color:#046963;">Quantity</h5></label>
                                                    <input type="number" class="form-control" name="quantity" value="1" min="1"/>
                                                </div>
                                                <button type="submit" class="button button-add-to-cart">Add to cart</button>
{{--                                                <a href="{{route('cart.add')}}" type="submit" class="btn btn-success">Add to cart</a>--}}
                            ...
                            <div class="row">
                                <div class="col-lg-10 m-auto entry-main-content">
                                    <h2 class="section-title style-1 mb-30">Product Long Description</h2>
