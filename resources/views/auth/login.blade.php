...
<!-- Mirrored from admin.pixelstrap.com/tivo/template/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 Feb 2023 09:13:58 GMT -->
<head>
    ...
    <div class="row m-0">
        <div class="col-12 p-0">
            <div class="login-card">
                <div>
                    <div><a class="logo" href="{{route('home')}}"><img class="img-fluid for-light" src="{{asset('/')}}admin/assets/images/logo/logo2.png" alt="looginpage"></a></div>
