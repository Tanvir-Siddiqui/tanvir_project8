                    ...
                    <div class="card-body">
                        <div class="d-sm-flex d-block justify-content-between">
                            <div class="flex-grow-1">
                                <div class="weather d-flex">
                                    <h2 class="f-w-400"> <span>28°<sup></sup>C </span></h2>
                                    <div class="span sun-bg" style="color:blue;"><i data-feather="sun"></i></div>
                                </div><span class="font-primary f-w-700">Sunny Day</span>
                                <p>Beautiful Sunny Day Walk</p>
                            </div>
                            <div class="badge-group">
                                <div class="badge badge-light-primary f-12"><i class="fa fa-clock-four"></i><span id="txt"></span></div>
                            </div>
                        </div>
                        <div class="greeting-user">
                            <div class="profile-vector">
                                ...
                                </ul><img class="img-fluid" src="{{asset('/')}}admin/assets/images/dashboard/default/profile.png" alt="">
                                <ul class="vector-image">
                                    <li> <img src="{{asset('/')}}admin/assets/images/dashboard/default/ribbon1.png" alt=""></li>
                                    <li> <img src="{{asset('/')}}admin/assets/images/dashboard/default/ribbon3.png" alt=""></li>
                                    <li> <img src="{{asset('/')}}admin/assets/images/dashboard/default/ribbon4.png" alt=""></li>
                                    <li> <img src="{{asset('/')}}admin/assets/images/dashboard/default/ribbon5.png" alt=""></li>
                                    <li> <img src="{{asset('/')}}admin/assets/images/dashboard/default/ribbon6.png" alt=""></li>
                                    <li> <img src="{{asset('/')}}admin/assets/images/dashboard/default/ribbon7.png" alt=""></li>
                                </ul>
                            </div>
                            <h4><a href="user-profile.html"><span>Welcome Back</span> {{Auth::user()->name}}  </a><span class="right-circle"><i class="fa fa-check-circle font-primary f-14 middle"></i></span></h4>
                ...
                <div class="card total-revenue overflow-hidden">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            <div class="flex-grow-1">
                                <p class="square-after f-w-600 header-text-primary">Total Revenue<i class="fa-s fa-circle-arrow-down"></i></p>
                                <h4>96.564%</h4>
                            </div>
                            <div class="setting-list">
                                <ul class="list-unstyled setting-option">
                                    <li>
                                        <div class="setting-light"></div>
                                    </li>
...
&lt;/div&gt;</code></pre>
                ...
                <div class="card total-investment">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <div class="flex-grow-1">
                                <p class="square-after f-w-600 header-text-primary">Total Investment<i class="fa-s fa-circle-arrow-down"> </i></p>
                                <h4>96.564%</h4>
                            </div>
                            <div class="setting-list">
                                <ul class="list-unstyled setting-option">
                                    <li>
                                        <div class="setting-light"><i class=""></i></div>
                                    </li>
                                    <li><i class="view-html fa fa-code font-white"></i></li>
                                    <li><i class="icofont icofont-maximize full-card font-white"></i></li>
                                    <li><i class="icofont icofont-minus minimize-card font-white"></i></li>
            ...
            <div class="col-xxl-3 col-xl-4 col-md-6 dash-30 box-col-35">
                <div class="card our-user">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <div class="flex-grow-1">
                                <p class="square-after f-w-600 header-text-primary">Our Total Users<i class="fa-s fa-circle-arrow-down"></i></p>
                                <h4>96.564%</h4>
                            </div>
                            <div class="setting-list">
                                <ul class="list-unstyled setting-option">
                    ...
                    <div class="card-body">
                        <div class="table-responsive theme-scrollbar">
                            <table class="table">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex"><img class="img-fluid align-top circle" src="{{asset('/')}}admin/assets/images/dashboard/default/01.png" alt="">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex"><img class="img-fluid align-top circle" src="{{asset('/')}}admin/assets/images/dashboard/default/02.png" alt="">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex"><img class="img-fluid align-top circle" src="{{asset('/')}}admin/assets/images/dashboard/default/03.png" alt="">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex"><img class="img-fluid align-top circle" src="{{asset('/')}}admin/assets/images/dashboard/default/04.png" alt="">
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex"><img class="img-fluid align-top circle" src="{{asset('/')}}admin/assets/images/dashboard/default/05.png" alt="">
      ...
      &lt;table class="table"&gt;
        &lt;tbody&gt;
          &lt;tr&gt;
            &lt;td&gt;
              &lt;div class="d-flex"&gt;
                &lt;img class="img-fluid align-top circle" src="{{asset('/')}}admin/assets/images/dashboard/default/01.png" alt=""&gt;&lt;/img&gt;
                &lt;div class="flex-grow-1"&gt;
          ...
          &lt;tr&gt;
            &lt;td&gt;
              &lt;div class="d-flex"&gt;
                &lt;img class="img-fluid align-top circle" src="{{asset('/')}}admin/assets/images/dashboard/default/02.png" alt=""&gt;&lt;/img&gt;
                &lt;div class="flex-grow-1"&gt;
                  &lt;a href="user-profile.html"&gt;
          ...
          &lt;tr&gt;
            &lt;td&gt;
              &lt;div class="d-flex"&gt;
                &lt;img class="img-fluid align-top circle" src="{{asset('/')}}admin/assets/images/dashboard/default/03.png" alt=""&gt;&lt;/img&gt;
                &lt;div class="flex-grow-1"&gt;
                  &lt;a href="user-profile.html"&gt;
          ...
          &lt;tr&gt;
            &lt;td&gt;
              &lt;div class="d-flex"&gt;
                &lt;img class="img-fluid align-top circle" src="{{asset('/')}}admin/assets/images/dashboard/default/04.png" alt=""&gt;&lt;/img&gt;
                &lt;div class="flex-grow-1"&gt;
                  &lt;a href="user-profile.html"&gt;
          ...
          &lt;tr&gt;
            &lt;td&gt;
              &lt;div class="d-flex"&gt;
                &lt;img class="img-fluid align-top circle" src="{{asset('/')}}admin/assets/images/dashboard/default/05.png" alt=""&gt;&lt;/img&gt;
                &lt;div class="flex-grow-1"&gt;
                  &lt;a href="user-profile.html"&gt;
                        ...
                        <div class="activity-timeline todo-timeline">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex mt-0"><img class="img-fluid img-30" src="{{asset('/')}}admin/assets/images/dashboard/default/todo.png" alt="">
      ...
      &lt;div class="d-flex"&gt;
        ...
        &lt;div class="flex-grow-1"&gt;
          ...
          &lt;div class="d-flex mt-0"&gt;
            &lt;img class="img-fluid img-30" src="{{asset('/')}}admin/assets/images/dashboard/default/todo.png" alt=""/&gt;
            &lt;div class="flex-grow-1"&gt;
