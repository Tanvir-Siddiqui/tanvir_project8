...
Route::get('/product/brand/{id}', [EcommerceController::class, 'brand'])->name('brand');
...
//Route::get('/cart/add-item/{id}', [CartController::class, 'cartAdd'])->name('cart.add');
...
Route::middleware(['auth:sanctum',config('jetstream.auth_session'),'verified'])->group(function () {
    ...
    //Order
    Route::get('/admin/order-manage', [AdminOrderController::class, 'orderManage'])->name('admin.order-manage');
